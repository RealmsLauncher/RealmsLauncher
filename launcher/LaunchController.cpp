...
void LaunchController::launchInstance()
{
    ...
    // DRM: Track this session
    if (m_licenseManager && m_session) {
        m_currentSessionId = m_session->session;
        m_licenseManager->addTargetJavaSession(m_currentSessionId);
    }
...
{
    if (m_licenseManager && !m_currentSessionId.isEmpty()) {
        m_licenseManager->removeTargetJavaSession(m_currentSessionId);
    }
    emitSucceeded();
}
